                                    ...
                                    <div class="col mb-30">
                                        <div class="product__items product__list--items d-flex">
                                            ...
                                            <div class="product__list--items__content">
                                                <h3 class="product__list--items__content--title h4 mb-10"><a href="{{ route('product.details', [$product->id, $product->product_slug]) }}">{{ $product->product_name}}</a></h3>
                                                ...
                                                <p class="product__list--items__content--desc mb-20">{{ $product->short_desc}}</p>
