                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__media--preview__items">
                                    <a class="product__media--preview__items--link glightbox" id="#thumb" data-gallery="product-media-preview" href="{{ url($product->product_thumbnail) }}"><img class="product__media--preview__items--img" src="{{ url($product->product_thumbnail) }}" alt="product-media-img"></a>
                            ...
                            <div class="swiper-slide">
                                <div class="product__media--preview__items">
                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ url($item->photo_name) }}"><img class="product__media--preview__items--img" src="{{ url($item->photo_name) }}" alt="product-media-img"></a>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img class="product__media--nav__items--img" src="{{ url($product->product_thumbnail) }}" alt="product-nav-img">
                                </div>
                            </div>
                            @foreach ($multiImages as $item )
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="{{ url($item->photo_name) }}" alt="product-nav-img">
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="col">
                <div class="product__details--info">
                    <form action="#">
                        ...
                        <p class="product__details--info__desc mb-20">{{ $product->short_desc }}</p>
                        <div class="row mb-4">
                            <div class="col-lg-6 mb-12">
                                <legend class="product__variant--title mb-8">Color :</legend>
                                <div class="checkout__input--list checkout__input--select select">
                                    {{-- <label class="checkout__select--label" for="country">Select Color</label> --}}
                                    <select class="checkout__input--select__field border-radius-5" id="">
                            ...
                            <div class="col-lg-6 mb-12">
                                ...
                                <div class="checkout__input--list checkout__input--select select">
                                    {{-- <label class="checkout__select--label" for="country">Select Size</label> --}}
                                    <select class="checkout__input--select__field border-radius-5" id="">
                            ...
                            <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                ...
                                <a type="button" class="btn quickview__cart--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>+ Add to cart</a>
                            </div>
                        ...
                        <div class="guarantee__safe--checkout">
                            ...
                            <img class="guarantee__safe--checkout__img" src="{{ asset('frontend') }}/assets/img/other/safe-checkout.png" alt="Payment Image">
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div id="description" class="tab_pane active show">
                            <div class="product__tab--content">
                                <div class="product__tab--content__step mb-30">
                                    ...
                                    <p class="product__tab--content__desc">{!! $product->long_desc !!}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="reviews__comment--area">
                                    <div class="reviews__comment--list d-flex">
                                        <div class="reviews__comment--thumb">
                                            <img src="{{ asset('frontend') }}/assets/img/other/comment-thumb1.png" alt="comment-thumb">
                                        </div>
                                    ...
                                    <div class="reviews__comment--list margin__left d-flex">
                                        <div class="reviews__comment--thumb">
                                            <img src="{{ asset('frontend') }}/assets/img/other/comment-thumb2.png" alt="comment-thumb">
                                        </div>
                                        <div class="reviews__comment--content">
                                            <div class="reviews__comment--top d-flex justify-content-between">
                                                <div class="reviews__comment--top__left">
                                    ...
                                    <div class="reviews__comment--list d-flex">
                                        <div class="reviews__comment--thumb">
                                            <img src="{{ asset('frontend') }}/assets/img/other/comment-thumb3.png" alt="comment-thumb">
                                        </div>
                                        <div class="reviews__comment--content">
                                            <div class="reviews__comment--top d-flex justify-content-between">
                                                <div class="reviews__comment--top__left">
