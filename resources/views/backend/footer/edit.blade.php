...
@section('main')
    ...
    <main id="main-container">
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Edit Footer</h1>
        ...
        <div class="content">
            ...
            <form action="{{ route('update.footer', $item->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Regular -->
                ...
                <div class="row push">
                    <div class="col-lg-10 col-xl-10" style="margin-left: 40px">
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <img class="float-end" src="{{ url($item->footer_logo) }}" height="100" width="100" id="footerLogo">
                            </div>

                            <div class="col-12 mb-4">
                                <label class="form-label" for="dm-profile-edit-firstname">Address <span style="color: red">*</span></label>
                                <input type="text" class="form-control" id="address" value="{{ $item->address }}" name="address" placeholder="Enter footer address">
                            </div>

                            <div class="col-6 mb-4">
                                <label class="form-label" for="dm-profile-edit-firstname">Phone <span style="color: red">*</span></label>
                                <input type="text" class="form-control" id="phone" value="{{ $item->phone }}" name="phone" placeholder="Enter phone number">
                            </div>

                            <div class="col-6 mb-4">
                                <label class="form-label" for="dm-profile-edit-firstname">Email <span style="color: red">*</span></label>
                                <input type="email" class="form-control" id="email" value="{{ $item->email }}" name="email" placeholder="Enter email address">
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="dm-profile-edit-firstname">Details <span style="color: red">*</span></label>
                                <textarea name="details" id="js-ckeditor">{{ $item->details }}</textarea>
                    ...
                    <div class="col-lg-8 col-xl-5 offset-lg-4">
                        <div class="mb-4">
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="fa fa-plus-circle opacity-50 me-1"></i> Update Footer
                            </button>
                        </div>
                    </div>
                </div>
