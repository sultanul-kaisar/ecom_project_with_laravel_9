        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Create Category</h1>
                    ...
                    <div class="col-lg-10 col-xl-10" style="margin-left: 40px">
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" id="category_icon" placeholder="Enter fa fa icon class" name="category_icon" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-xl-5 offset-lg-4">
                        <div class="mb-4">
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="fa fa-plus-circle opacity-50 me-1"></i> Add Category
                            </button>
                        </div>
                    </div>
                </div>
