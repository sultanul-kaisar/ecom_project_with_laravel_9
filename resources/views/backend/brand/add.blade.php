        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Add Brand</h1>
        ...
        <div class="content">
            ...
            <form action="{{ route('store.brand') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="content-header col-11 mb-4">
                    <h2 class="content-heading">Add New Brand</h2>
                    ...
                    <div class="col-lg-10 col-xl-10" style="margin-left: 40px">
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                ...
                                <input type="file" class="form-control" onchange="imageUrl(this)" id="brand_image" name="brand_image" required>
                            </div>
                            <div class="col-12">
                                <img class="float-end" src="" id="brandImage">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-xl-5 offset-lg-4">
                        <div class="mb-4">
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="fa fa-plus-circle opacity-50 me-1"></i> Add Brand
                            </button>
                        </div>
                    </div>
                </div>
