                    ...
                    <div class="col-lg-10 col-xl-10" style="margin-left: 40px">
                        <div class="row mb-4">
                            <div class="col-6 mb-4">
                                ...
                                <input type="text" class="form-control" id="slider_title" name="slider_title" value="{{ $slider->slider_title }}" placeholder="Enter title in english" >
                            </div>

                            <div class="col-6 mb-4">
                                <label class="form-label" for="dm-profile-edit-lastname">Slider Description</label>
                                <textarea type="text" class="form-control" id="description" name="description" placeholder="Enter slider description" >{{ $slider->description }}</textarea>
                            </div>

                            <div class="col-6">
                                <label class="form-label" for="dm-profile-edit-street-1">Slider Image <span style="color: red">*</span></label>
                                <input type="file" class="form-control" onchange="imageUrl(this)" id="slider_img" name="slider_img">
                            </div>
                            <div class="col-5">
                                <img src="{{ url($slider->slider_img) }}" height="100" width="250" id="sliderImage">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-xl-5 offset-lg-4">
                        <div class="mb-4">
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="fa fa-plus-circle opacity-50 me-1"></i> Update Slider
                            </button>
                        </div>
                    </div>
                </div>
