        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Create Shipping State</h1>
                    <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Create Shipping State</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <form action="{{ route('store.state') }}" method="POST">
                ...
                <div class="content-header col-11 mb-4">
                    <h2 class="content-heading">Add New Shipping State</h2>
                    ...
                    <div class="col-lg-10 col-xl-10" style="margin-left: 40px">
                        <div class="row mb-4">
                            ...
                            <div class="col-6 mb-4">
                                ...
                                <input type="text" class="form-control" id="shipstate_name" name="shipstate_name" placeholder="Enter State Name" required>
                            </div>
                    ...
                    <div class="col-lg-8 col-xl-5 offset-lg-4">
                        <div class="mb-4">
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="fa fa-plus-circle opacity-50 me-1"></i> Add State Name
                            </button>
                        </div>
                    </div>
                </div>
